...
library(psych)
corrplot(cor(train[, c(3, 8, 9, 11, 13, 14)]), method = "ellipse") 
corPlot(train[, c(3, 8, 9, 11, 13, 14)], cex = 1.2, main = "Matriz de correlación")
corrplot(cor(train[, c(3, 8, 9, 11, 13, 14)]),method = "circle",       order = "hclust",         hclust.method = "ward.D",
